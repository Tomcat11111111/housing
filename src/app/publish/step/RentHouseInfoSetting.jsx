...
const rentHouseSchema = yup.object().shape({
  squareMeters: yup
    .number()
    .typeError('請輸入坪數')
    .required('請輸入坪數')
...
const RentHouseInfoSetting = forwardRef((props, ref) => {
  const { property, setProperty, rentalInfo, setRentalInfo } = usePublishStore();
  ...
  const {
    ...
    mode: 'onChange',
    resolver: yupResolver(rentHouseSchema),
    values: {
  ...
  const handleRentalInfoChange = async (field, value) => {
    setRentalInfo({
      ...rentalInfo,
      [field]: value,
    });
      ...
      <FieldGroup title="物件細項">
        <TextField
          ...
          onChange={(e) => {
            ...
            handlePropertyChange('squareMeters', value);
          }}
      ...
      <FieldGroup title="物件租金/押金">
        <TextField
          ...
          onChange={(e) => {
            ...
            handleRentalInfoChange('price', value)
          }}
          error={!!errors.price}
          ...
          <FormControl>
            ...
            <FormControl>
              ...
              <RadioGroup
                ...
                onChange={(e) => {
                  setRentalInfo({ pets: e.target.value })}}
              >
              <div className="flex gap-6 items-center">
                <FormControlLabel className="mx-0 w-[100px]" value={true} control={<Radio />} label="可以" />
                <FormControlLabel className="mx-0 w-[100px]" value={false} control={<Radio />} label="不可以" />
              </div>
              </RadioGroup>
              </div>
            </FormControl>
...
RentHouseInfoSetting.displayName = 'RentHouseInfoSetting';
